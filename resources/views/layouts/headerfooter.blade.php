	...
	<header class="header-section">
		<div class="container-fluid">
			...
			<div class="header-right">
				<a href="{{ url('cart') }}" class="card-bag"><img src="{{ asset('frontend/img/icons/bag.png')}}" alt=""><span>{{ App\Models\Cart::where('customer_ip',$_SERVER['REMOTE_ADDR'])->count() }}</span></a>
			</div>
			<!-- site menu -->
			<ul class="main-menu">
				...
				@foreach ($categories as $category)
					<li><a href="{{ url('categorywiseproduct') }}/{{ $category->id }}">{{ $category->category_name }}</a></li>
				@endforeach
